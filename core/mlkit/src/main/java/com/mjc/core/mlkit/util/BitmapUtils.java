...
public class BitmapUtils {
    ...
    try {
      ...
      try {
        image.compressToJpeg(
            new Rect(0, 0, metadata.getWidth(), metadata.getHeight()), 80, stream);
  ...
  public static Bitmap getBitmapFromContentUri(ContentResolver contentResolver, Uri imageUri)
      throws IOException {
    // First decode with inJustDecodeBounds to get dimensions without allocating memory
    ...
    // Calculate inSampleSize to limit max dimension
